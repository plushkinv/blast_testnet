...
for private_key in keys_list:
    ...
    try:
        ...
        dapp_abi = json.load(open('abi/omnix.json'))
        dapp_address = web3.to_checksum_address("0x5A310466ede9E4BD9B729535F53EB89e147e0Fd7")
        dapp_contract = web3.eth.contract(address=dapp_address, abi=dapp_abi)


        value = web3.to_wei(price*skolko_nft_mintit, "ether")
